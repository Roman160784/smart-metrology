...
const traceabilityE6 = 'Обеспечивается прослеживаемость результатов измерений до Национальных эталонов электрического сопротивления - НЭ РБ 29-16, напряжения переменного тока в диапазоне частот 10 Гц – 2 ГГц НЭ РБ 5-01'
    ...
    async (param: {reportId: string}, { dispatch, rejectWithValue }) => {
        try {
            let newReportMrp120 = {
                ...
                method: 'МК.ГМ 1580 - 2013, МК.ГМ 2186- 2019 Метод непосредственной оценки',
                temperature: '21,0',
